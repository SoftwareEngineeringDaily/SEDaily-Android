...
public class MediaNotificationManager extends BroadcastReceiver {
  ...
  private static final String CHANNEL_ID = "com.koalatea.sedaily.MUSIC_CHANNEL_ID";

  private static final int NOTIFICATION_ID = 412;
  private static final int REQUEST_CODE = 100;

  public static final String ACTION_PAUSE = "com.koalatea.sedaily.pause";
  public static final String ACTION_PLAY = "com.koalatea.sedaily.play";
  public static final String ACTION_PREV = "com.koalatea.sedaily.prev";
  public static final String ACTION_NEXT = "com.koalatea.sedaily.next";
  public static final String ACTION_STOP = "com.koalatea.sedaily.stop";
  public static final String ACTION_STOP_CASTING = "com.koalatea.sedaily.stop_cast";
...
//              mService.getString(R.string.label_previous), mPreviousIntent);
    ...
    if (mPlaybackState.getState() == PlaybackStateCompat.STATE_PLAYING) {
      ...
      icon = R.drawable.ic_pause_black_36dp;
      intent = mPauseIntent;
    } else {
...
//      notificationBuilder.addAction(R.drawable.ic_play_arrow_black_36dp,
